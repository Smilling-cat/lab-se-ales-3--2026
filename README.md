...
Las señales se capturaron en formato .wav utilizando una frecuencia de muestreo, garantizando una resolución adecuada para el análisis de armónicos superiores.

## Fase 2
 Se aplicó el algoritmo de la FFT a cada señal para descomponerla en sus componentes sinusoidales y obtener el espectro de magnitudes.

### Extracción de Atributos Espectrales
Identificado como el pico de mayor magnitud en el espectro de bajas frecuencias.

Se calculó el centroide espectral y la concentración de energía por encima de los 1500 Hz para determinar el timbre.

## Fase 3
Pre-procesamiento y Filtrado Digital
Se implementaron filtros pasa-banda de tipo Respuesta Impulsional Finita (FIR) para aislar la región de interés vocal y mitigar ruidos externos.
Para voces masculinas se estableció un rango de 80-400 Hz, mientras que para las femeninas se utilizó un rango de 150-500 Hz.
...
Determina el tono agudo o grave y es el primer armónico del espectro. 
...
Se registraron 6 señales en total, 3 mujeres y 3 de hombres, todos adultos jóvenes sin patologías vocales diagnosticadas.

Cada sujeto emitió una vocal sostenida (generalmente la /a/ o la /e/) o una frase fonéticamente balanceada durante un lapso de 5 segundos, manteniendo una distancia constante de 10-15 cm respecto al celular.
